          ...
          <div className="space-y-8">
            ...
            <div className="bg-card/80 backdrop-blur-sm p-6 rounded-lg shadow-natural border border-border/50">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-lg font-semibold">Join Our Monthly Newsletter</h3>
              </div>
          ...
          <div className="flex justify-center">
            <div className="relative">
              <div className="w-96 h-96 rounded-full overflow-hidden shadow-warm border-4 border-accent/30 spiral-hover">
                <img 
                  src={wheelImage} 
                  alt="Wheel of the Year featuring Colorado native species" 
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="absolute -bottom-4 -right-4 bg-seasonal-summer text-white px-4 py-2 rounded-full font-semibold shadow-lg">
